...
(provided by this skill's uv project; invoke via bin/run) for writing the deck. Slides are 13.333in × 7.5in
...
def main():
    ...
    try:
        ...
        sys.exit("error: python-pptx is missing — invoke this script via bin/run (uv), not system python3")
