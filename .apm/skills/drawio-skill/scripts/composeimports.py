...
Requires PyYAML (provided by this skill's uv project; invoke via bin/run). `--group` boxes services by their
first network.
...
def main():
    ...
    try:
        ...
        sys.exit("error: PyYAML is missing — invoke this script via bin/run (uv), not system python3")
