...
```bash
<this-skill-dir>/bin/run shapesearch.py "aws lambda" --limit 5
<this-skill-dir>/bin/run shapesearch.py "uml actor" --json
```
...
```bash
<this-skill-dir>/bin/run aiicons.py "claude" --json        # CDN reference
<this-skill-dir>/bin/run aiicons.py "openai" --embed        # self-contained
<this-skill-dir>/bin/run aiicons.py --list                  # all brands
```
