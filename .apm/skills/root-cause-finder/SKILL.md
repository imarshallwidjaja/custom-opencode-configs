...
Use this skill when:
- Debugging protocol errors, deserialization failures, null payloads
- Investigating missing fields, restore/hydration issues
- Tracking state-ownership bugs, unexpected requests
- Reviewing background mutations
- Code review where visible failure may be downstream noise
...
- **test-driven-development** - For creating failing test cases to reproduce bugs
- **verification-before-completion** - Use for verifying fixes before claiming work complete
