...
Usage:
    uv run --with python-pptx python extract-pptx.py <input.pptx> [output_dir]

Requires python-pptx. Prefer uv --with over pip.
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: uv run --with python-pptx python extract-pptx.py <input.pptx> [output_dir]")
        sys.exit(1)
