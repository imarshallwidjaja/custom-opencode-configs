...
Use this as the placement decision skill when `test-driven-development` or final verification leaves open where lasting coverage should live.
...
- **test-driven-development** - Use for writing proper failing tests before implementing fixes
