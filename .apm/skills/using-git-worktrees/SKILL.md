...
2. ~/.local/share/opencode/worktrees/<project-name>/ (global location)
...
Fix broken worktree hygiene immediately:
...
### For Global Directory (~/.local/share/opencode/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.local/share/opencode/worktrees/*)
    path="$HOME/.local/share/opencode/worktrees/$project/$BRANCH_NAME"
    ;;
esac
