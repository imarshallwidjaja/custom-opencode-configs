...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/varunr89/resume-tailoring-skill.git ~/.config/opencode/skill/resume-tailoring
   ```

2. **Verify installation:**
   ```bash
   ls ~/.config/opencode/skill/resume-tailoring
   ```
   You should see: `SKILL.md`, `research-prompts.md`, `matching-strategies.md`, `branching-questions.md`, `README.md`

3. **Restart OpenCode** (if already running)

### Option 2: Manual Installation

1. **Create the skill directory:**
   ```bash
   mkdir -p ~/.config/opencode/skill/resume-tailoring
   ```

2. **Download the files:**
   - Download all files from this repository
   - Place them in `~/.config/opencode/skill/resume-tailoring/`
...
**Run tests:**
```bash
cd ~/.config/opencode/skill/resume-tailoring
...
**Skill not appearing:**
- Verify files are in `~/.config/opencode/skill/resume-tailoring/`
- Restart OpenCode
