...
- Shared prompt-backed commands are canonical under `.apm/prompts/`. Use `.apm/cursor/commands/` only for genuinely Cursor-specific commands; never duplicate a shared prompt there.
